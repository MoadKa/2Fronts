<!-- ARCHIV — Stand 2026-07-30.
     Dieses Dokument war bis 2026-07-30 die Wurzel-DESIGN.md. Es ist nicht mehr
     die verbindliche Richtung: der Founder hat am 2026-07-30 entschieden, die
     UI end-to-end neu zu machen (Marketing, App, Concierge-Seite) — inklusive
     der Richtung selbst. Hier aufbewahrt, weil die Entscheidung vom 2026-07-04
     echt war und ihre Analyse (die zwei Schmerzen, „Antwortet um 23 Uhr", die
     Font- und Anti-Slop-Verbote) für die neue Welt Material bleibt.
     Die Wurzel-DESIGN.md hält jetzt den ausgelieferten Ist-Zustand fest. -->
